...
public abstract class Controller_AbstractClass {
	...
	public void exec_2Stufig_Fixed_View(String cmd, String konto1, String[] kontoSelection, String konto3, String steuer, boolean fixed, boolean leftMore) {
	...
	public void exec_2Stufig_VariableKonto(String cmd, String konto1, String[] kontoSelection, String konto3, String steuer, boolean fixed, boolean leftMore) {		
		_2Stufig_VariableKonto view = new _2Stufig_VariableKonto();
		view.setUpBasicStuff(cmd, konto1, kontoSelection, konto3, steuer, fixed, this, leftMore);
	}
	
	
	public void exec_2Stufig_Fixed_NTRabatt_View(String cmd, String konto1, String[] kontoSelection, String konto3, String steuer, boolean fixed, boolean leftMore) {
		_2Stufig_Fixed_NTRabatt_View view = new _2Stufig_Fixed_NTRabatt_View();
		view.setUpBasicStuff(cmd, konto1, kontoSelection, konto3, steuer, fixed, this, leftMore);
	}
	
	public void exec_1Stufig_ohneSteuer(String cmd, String konto1, String[] kontoSelection, String konto3, String steuer, boolean fixed, boolean leftMore) {
