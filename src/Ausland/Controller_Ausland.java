...
public class Controller_Ausland extends Controller_AbstractClass{
	...
	public IG_Erwerb_Kauf_View exec_IG_Erwerb_Kauf_View(String cmd, String konto1, String[] kontoSelection, String konto3, String konto4, String konto5, String percent, int[] coordinates, boolean fixed, String extra, boolean leftMore) {
	...
	public void exec_Ausland_Ausgleich(String cmd, String konto1, String[] kontoSelection, String konto3, String konto4, String konto5, String percent, int[] coordinates, boolean fixed, String extra, boolean leftMore) {
		Ausland_Ausgleich view = new Ausland_Ausgleich();
		view.setUpBasicStuff(cmd, konto1, kontoSelection, konto3, konto4, konto5, percent, coordinates, fixed, extra, this, leftMore);
		view.setVisible(true);
	}
	
	public void exec_Kursdifferenz_View(String cmd, String konto1, String[] kontoSelection, String konto3, String steuer, int[] coordinates, boolean fixed, boolean leftMore) {
