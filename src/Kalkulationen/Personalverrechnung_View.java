...
public class Personalverrechnung_View extends JFrame {
	...
	public Personalverrechnung_View(Controller_Kalkulationen myController) {
		...
		if (mainPane != null) {
			...
			infoLabel.setBounds(20, 640, 200, 30);
			...
			btnLöse.addActionListener(new ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					MainView.llSearchNames.get(MainView.llSearchNames.size() - 3)
							.setText("Kalkulationen" + "   " + MainView.kalkulationsOpen);
				}
	...
	public void setUpStuff(boolean zumutbar, boolean unzumutbar) throws NumberFormatException, IOException {
		...
		Double BG = myController.execCalcSV_LS(gehalt_lohn, fahrtstrecke, freibetrag, eCardGebühr, gewerkschaftsbeitrag,
				akonto, zumutbar);
