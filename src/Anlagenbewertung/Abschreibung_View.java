...
public class Abschreibung_View extends View_SuperClass{
	...
	private void makeAnlKonto() {
		...
		txtAnlage.setBounds(300, yFirst, 200, 26);
	...
	private void makeND() {
		...
		txtND.setBounds(850, yFirst, 210, 40);
	...
	private void make_Monat_IBN() {
		...
		txtIBN_Monat.setBounds(850, ySecond+5, 210, 40);
	...
	private void make_Year_IBN() {
		...
		txtIBN_Year.setBounds(1070, ySecond+5, 200, 40);
	...
	private void makeCheckBoxes() {
		...
		firstTwo.setBounds(611, yFirst, 200, 25);
		...
		lastTwo.setBounds(611, ySecond, 200, 25);
		...
		allYears.setBounds(611, ySecond + (ySecond-yFirst), 200, 25);
